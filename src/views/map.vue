<template>
  <div id="map">
    <span class="goMap" @click="goBack()">返回</span>
    <el-row class="mb_20">
      <div class="bw">
    ...
    <el-row>
      <div class="bw">
        <div class="title">迁徙图</div>
        <div id="map_migration" style="height:700px;width:100%"></div>
      </div>
    </el-row>
  </div>
</template>
...
export default {
  ...
  created () {},
  mounted () {
    // 使用的是echart的百度地图功能，需要引入百度地图和echart的bmap.js
    this.map_hot()
    this.map_migration()
  },
  methods: {
